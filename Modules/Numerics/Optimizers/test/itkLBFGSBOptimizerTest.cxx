...
public:
  ...
  MeasureType GetValue( const ParametersType & position ) const
  {
...
int itkLBFGSBOptimizerTest(int, char *[])
{
  ...
  const itk::DefaultParameterValueType F_Convergence_Factor  = 1e+7;      // Function value tolerance
  const itk::DefaultParameterValueType Projected_G_Tolerance = 1e-5;      // Proj gradient tolerance
  ...
  itk::DefaultParameterValueType trueParameters[2] = { 4.0/3.0, -1.0 };
