...
VectorResampleImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType, TTransformPrecisionType >
::VectorResampleImageFilter()
{
  ...
  m_Transform = IdentityTransform< TTransformPrecisionType, ImageDimension >::New();
