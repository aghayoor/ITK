...
int main( int argc, char *argv[] )
{
  ...
  //  parameters can easily be infered from the result of the previous stage like when a
  ...
  //  However, for the transforms with larger parameters set, it is not intuitive for user to
