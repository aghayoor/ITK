...
int main( int argc, char *argv[] )
{
  ...
  //  Software Guide : BeginLatex
  //
  //  The initial transform object is constructed below.
  //
  ...
  //  Software Guide : BeginLatex
  //
  //  Now we pass the parameters of the initial transform as the initial
  //  parameters to be used when the registration process starts.
  //
  //  Software Guide : EndLatex

  // Software Guide : BeginCodeSnippet
  registration->InitializeOptimizableParametersFromTransform( initialTransform );
  // Software Guide : EndCodeSnippet
  ...
  //  \index{itk::RegistrationMethodv4!GetOutput()->Get()->GetParameters()}
  //
  //  Software Guide : EndLatex
  ...
  const double finalRotationCenterX = finalTransform->GetCenter()[0];
  const double finalRotationCenterY = finalTransform->GetCenter()[1];
